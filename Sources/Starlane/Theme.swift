...
enum Theme {
    ...
    static let pulse = NSColor(calibratedRed: 1.0, green: 0.92, blue: 0.35, alpha: 1)
    static let rail = NSColor(calibratedRed: 0.55, green: 0.75, blue: 1.0, alpha: 1)
    static let enemyLaser = NSColor(calibratedRed: 1.0, green: 0.35, blue: 0.30, alpha: 1)
    static let militia = NSColor(calibratedRed: 0.55, green: 0.72, blue: 0.40, alpha: 1)
